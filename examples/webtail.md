...
```bash
denoflare push --name webtail https://raw.githubusercontent.com/skymethod/denoflare/v0.4.3/examples/webtail-worker/webtail_worker.ts
```
...
```bash
denoflare serve https://raw.githubusercontent.com/skymethod/denoflare/v0.4.3/examples/webtail-worker/webtail_worker.ts
```

...
This [open-source worker](https://github.com/skymethod/denoflare/tree/v0.5.3/examples/r2-public-read-worker) makes a single R2 bucket available via public-read with the following features:
...
```
denoflare push https://raw.githubusercontent.com/skymethod/denoflare/v0.5.3/examples/r2-public-read-worker/worker.ts \
...
The worker takes [five environment variables](https://github.com/skymethod/denoflare/blob/v0.5.3/examples/r2-public-read-worker/worker_env.d.ts)
...
```jsonc
{
	...
	"scripts": {
        ...
        "my-bucket-public-read": {
            ...
            "path": "https://raw.githubusercontent.com/skymethod/denoflare/v0.5.3/examples/r2-public-read-worker/worker.ts",

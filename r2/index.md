...
Each subcommand makes R2 calls via our [R2 TypeScript API](https://github.com/skymethod/denoflare/tree/v0.5.8/common/r2), available as a module or individual functions.

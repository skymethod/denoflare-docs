...
Each subcommand makes R2 calls via our [R2 TypeScript API](https://github.com/skymethod/denoflare/tree/v0.5.9/common/r2), available as a reusable module or individual functions for your own projects.
...
For non-Deno or non-TypeScript environments, you can create a single JS file (ESM module) with `deno bundle https://raw.githubusercontent.com/skymethod/denoflare/v0.5.9/common/r2/r2.ts`.

Or if you don't have Deno installed, using our on-demand [deno bundle as a service](https://bundle.deno.dev): `https://bundle.deno.dev/https://raw.githubusercontent.com/skymethod/denoflare/v0.5.9/common/r2/r2.ts`
</Aside>
...
denoflare-r2-list-buckets 0.5.9
...
denoflare-r2-head-bucket 0.5.9
...
denoflare-r2-create-bucket 0.5.9
...
denoflare-r2-delete-bucket 0.5.9
...
denoflare-r2-get-bucket-encryption 0.5.9
...
denoflare-r2-delete-bucket-encryption 0.5.9
...
denoflare-r2-put-bucket-encryption 0.5.9
...
denoflare-r2-get-bucket-location 0.5.9
...
denoflare-r2-list-objects 0.5.9
...
denoflare-r2-list-objects-v1 0.5.9
...
denoflare-r2-head-object 0.5.9
...
denoflare-r2-delete-object 0.5.9
...
denoflare-r2-delete-objects 0.5.9
...
denoflare-r2-copy-object 0.5.9
...
denoflare-r2-create-multipart-upload 0.5.9
...
denoflare-r2-abort-multipart-upload 0.5.9
...
denoflare-r2-complete-multipart-upload 0.5.9
...
denoflare-r2-upload-part 0.5.9
...
denoflare-r2-upload-part-copy 0.5.9
...
denoflare-r2-list-multipart-uploads 0.5.9
...
denoflare-r2-generate-credentials 0.5.9

...
```bash
deno install --unstable --allow-read --allow-net --allow-env --name denoflare --force https://raw.githubusercontent.com/skymethod/denoflare/v0.4.1/cli/cli.ts
```
...
# in ~/.bash_profile
function denoflare {
    deno run --unstable --allow-read --allow-net --allow-env https://raw.githubusercontent.com/skymethod/denoflare/v0.4.1/cli/cli.ts "$@"
}
```
...
```bash
deno run --unstable --allow-read --allow-net --allow-env https://raw.githubusercontent.com/skymethod/denoflare/v0.4.1/cli/cli.ts serve x
```
